    ...
    <div class="w-full max-w-lg">
        ...
        <AppCard v-else-if="pet" :title="pet.name">
            <dl class="space-y-4 text-sm">
                ...
                <div v-if="pet.photoUrls?.length" class="flex justify-between">
                    <dt class="text-gray-500">Zdjęcie</dt>
                    <dd>
                        <a :href="pet.photoUrls[0]" target="_blank" class="text-green-600 hover:underline text-xs">
                            Zobacz
                        </a>
                    </dd>
                </div>
